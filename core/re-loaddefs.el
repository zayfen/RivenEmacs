;;; re-loaddefs.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...

;;; Generated autoloads from ../elisp/+rivenemacs.el

(autoload '+error! "../elisp/+rivenemacs" "\
Log error MSG and VARS using `message'.

(fn MSG &rest VARS)" nil t)
(autoload '+info! "../elisp/+rivenemacs" "\
Log info MSG and VARS using `message'.

(fn MSG &rest VARS)" nil t)
(autoload '+log! "../elisp/+rivenemacs" "\
Log MSG and VARS using `message' when `rivenemacs-verbose' is non-nil.

(fn MSG &rest VARS)" nil t)
(autoload '+debug! "../elisp/+rivenemacs" "\
Log error MSG and VARS using `message'.

(fn MSG &rest VARS)" nil t)
(autoload '+emacs-features-p "../elisp/+rivenemacs" "\
Is features FEATS are enabled in this Emacs build.

(fn &rest FEATS)")
(autoload '+fn-inhibit-messages! "../elisp/+rivenemacs" "\
...
(autoload '+shutup! "../elisp/+rivenemacs" "\
Suppress new messages temporarily in the echo area and the `*Messages*' buffer while BODY is evaluated.

(fn &rest BODY)" nil t)
(autoload '+suppress! "../elisp/+rivenemacs" "\
Suppress new messages temporarily in the echo area while BODY is evaluated.

(fn &rest BODY)" nil t)
(autoload '+cmdfy! "../elisp/+rivenemacs" "\
...
(autoload '+eval-when-idle-for! "../elisp/+rivenemacs" "\
...
(autoload '+deferred! "../elisp/+rivenemacs" "\
Run BODY after Emacs gets loaded, a.k.a. after `rivenemacs-loaded'.

(fn &rest BODY)" nil t)
(autoload '+deferred-when! "../elisp/+rivenemacs" "\
...
(autoload '+compile-functions "../elisp/+rivenemacs" "\
Queue FNS to be byte/natively-compiled after a brief delay.

(fn &rest FNS)")
(autoload '+env-save "../elisp/+rivenemacs" "\
Load environment variables of the current session to the file
  \".emacs.d/local/system-env.el\"." t)
(autoload '+env-load "../elisp/+rivenemacs" "\
Load environment variables from the file saved in
  \".emacs.d/local/system-env.el\" if available." t)
(autoload '+ignore-root "../elisp/+rivenemacs" "\
Add ROOTS to ignored projects, recentf, etc.

(fn &rest ROOTS)")
(register-definition-prefixes "../elisp/+rivenemacs" '("+eval-when-idle-"))
...

;;; Generated autoloads from re-core-ui.el

(register-definition-prefixes "re-core-ui" '("+theme--tweaks-h"))


;;; Generated autoloads from ../modules/extras/re-dap-utils.el

(autoload '+github-latest-release "../modules/extras/re-dap-utils" "\
...

;;; Generated autoloads from re-defaults.el

(register-definition-prefixes "re-defaults" '("+whitespace-auto-cleanup-modes"))


;;; Generated autoloads from ../modules/extras/re-eglot-ltex-extras.el

(register-definition-prefixes "../modules/extras/re-eglot-ltex-extras" '("eglot-ltex-"))


;;; Generated autoloads from ../modules/extras/re-elisp-extras.el

(register-definition-prefixes "../modules/extras/re-elisp-extras" '("+elisp-" "+emacs-lisp--"))


;;; Generated autoloads from ../modules/extras/re-gdb.el

(autoload '+gdb-set-layout "../modules/extras/re-gdb" "\
Enable custom window layout for gdb." t)
(autoload '+emacs-gdb-enable "../modules/extras/re-gdb" "\
Load a faster \"gdb\" command from \"emacs-gdb\".
This will overwrite the built-in \"gdb-mi\" for this session." t)
(register-definition-prefixes "../modules/extras/re-gdb" '("+gdb-"))


;;; Generated autoloads from re-modules.el

(register-definition-prefixes "re-modules" '("rivenemacs-"))


;;; Generated autoloads from ../modules/extras/re-mu4e-extras.el

(autoload '+mu4e-extras-setup "../modules/extras/re-mu4e-extras")
(register-definition-prefixes "../modules/extras/re-mu4e-extras" '("+mu4e-" "+org-msg-make-signature"))


;;; Generated autoloads from ../modules/extras/re-mu4e-gmail.el

(register-definition-prefixes "../modules/extras/re-mu4e-gmail" '("+mu4e-"))


;;; Generated autoloads from ../modules/extras/re-mu4e-ui.el

(register-definition-prefixes "../modules/extras/re-mu4e-ui" '("+mu4e-"))


;;; Generated autoloads from ../modules/extras/re-org-extras.el

(register-definition-prefixes "../modules/extras/re-org-extras" '("+org-"))


;;; Generated autoloads from ../modules/extras/re-realgud.el

(autoload '+realgud:start "../modules/extras/re-realgud" "Start the RealGUD debugger suitable for the current mode." t)
(autoload '+realgud:toggle-breakpoint "../modules/extras/re-realgud" "Toggle break point." t)
(autoload '+realgud-hydra/body "../modules/extras/re-realgud" "Hydra keys for RealGUD." t)
(register-definition-prefixes "../modules/extras/re-realgud" '("+realgud:cmd-"))


;;; Generated autoloads from ../modules/extras/re-spell-fu.el

(autoload '+spell-fu-correct "../modules/extras/re-spell-fu" "\
Correct spelling of word at point." t)
(autoload '+spell-fu-register-dictionaries "../modules/extras/re-spell-fu" "\
Register dictionaries for `LANGS` to spell-fu's multi-dict.

(fn &rest LANGS)" nil t)
(register-definition-prefixes "../modules/extras/re-spell-fu" '("+spell-fu--"))


;;; Generated autoloads from re-splash.el

(register-definition-prefixes "re-splash" '("rivenemacs-splash"))


;;; Generated autoloads from re-vars.el

(register-definition-prefixes "re-vars" '("+env-save-vars" "emacs/features" "rivenemacs-" "os/" "sys/arch"))


;;; Generated autoloads from ../modules/extras/re-writing-mode.el

(autoload '+writing-mode "../modules/extras/re-writing-mode" "\
...
(fn &optional ARG)" t)
(register-definition-prefixes "../modules/extras/re-writing-mode" '("+writing-"))
