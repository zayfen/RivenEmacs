...
(when (display-graphic-p)
  (cl-loop for font in '("Liga SFMono Nerd Font" "JetBrains Mono" "FiraCode Nerd Font"
           ...
           return (set-face-attribute
                   ...
                   :font (font-spec :family font
                                    :weight 'normal
                                    :scale (cond ((eq system-type 'gnu/linux) 1.2)
  ...
  (cl-loop for font in '("Sarasa Mono SC" "PingFang SC" "Microsoft YaHei" "Noto Sans CJK SC"
                       "Source Han Sans SC" "WenQuanYi Micro Hei")
           when (font-installed-p font)
           return (set-fontset-font t 'han
                                   (font-spec :family font
                                              :scale (cond ((eq system-type 'gnu/linux) 1)
                                                          ((eq system-type 'windows-nt) 1)
                                                          ((eq system-type 'darwin) 1)))))
