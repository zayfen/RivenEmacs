;;; re-embedded.el --- Embedded systems stuff -*- lexical-binding: t; -*-
...
(use-package x86-lookup
  ...
  (x86-lookup-pdf (concat rivenemacs-local-dir "x86-lookup/325383-sdm-vol-2abcd.pdf")))


(provide 're-embedded)

;;; re-embedded.el ends here
