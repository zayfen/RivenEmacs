;;; re-mu4e.el --- Email stuff using mu4e -*- lexical-binding: t; -*-
...
(defgroup rivenemacs-mu4e nil
  "RivenEmacs mu4e tweaks."
  :group 'rivenemacs)
  ...
  (defun +mu4e-open-mail-as-html ()
    ...
    (if-let ((msg (mu4e-message-at-point t))
             ...
             (browse-url-browser-function
              (cond
               ((featurep 're-eaf) #'eaf-open-browser)
...
(use-package re-mu4e-extras
  :after mu4e
  :demand t
  :config
  ;; Enable RivenEmacs's mu4e extra features, including:
