;;; re-vc.el --- Git and version control -*- lexical-binding: t; -*-
...
(use-package forge
  ...
  (forge-database-file (concat rivenemacs-local-dir "forge/database.sqlite")))

(use-package emojify ;; Needed by `code-review'
  :straight t
  :custom
  (emojify-emoji-set "emojione-v2.2.6")
  (emojify-emojis-dir (concat rivenemacs-cache-dir "emojify/emojis/"))
