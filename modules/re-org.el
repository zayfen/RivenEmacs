;;; re-org.el --- Org related stuff -*- lexical-binding: t; -*-
...
(defgroup rivenemacs-org nil
  "RivenEmacs org-mode tweaks."
  :group 'rivenemacs)
...
(use-package org
  ...
  (org-export-async-init-file (expand-file-name (concat rivenemacs-modules-dir "extras/re-org-export-async-init.el")))
  ...
  (setq org-export-async-debug rivenemacs-debug) ;; Can be useful!
  ...
  (defvar +org-level-base-size 1.2)
