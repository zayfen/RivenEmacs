;;; re-projectile.el --- Projectile -*- lexical-binding: t; -*-
...
(use-package projectile
  ...
  :demand t
  :custom
  (projectile-cache-file (+directory-ensure rivenemacs-cache-dir "projectile/cache.el"))
  (projectile-known-projects-file (+directory-ensure rivenemacs-local-dir "projectile/known-projects.el"))
...
(provide 'obsolete/re-projectile)
