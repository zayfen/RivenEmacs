;;; re-flycheck.el --- Programming stuff -*- lexical-binding: t; -*-
...
(use-package flycheck
  ...
  (+load (file-name-directory (or load-file-name buffer-file-name)) "re-flycheck-cmake.el")
  (+load (file-name-directory (or load-file-name buffer-file-name)) "re-flycheck-eglot.el")
  :config
