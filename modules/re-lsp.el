;;; re-lsp.el --- Debugging and programming using lsp-mode and dap-mode -*- lexical-binding: t; -*-
...
;;   :custom
;;   (lsp-session-file (concat rivenemacs-local-dir "lsp/session.el"))
;;   (lsp-server-install-dir (concat rivenemacs-local-dir "lsp/servers/"))
;;   (lsp-keep-workspace-alive nil)
;;   (lsp-log-io nil)
;;   (lsp-idle-delay 1.0)
;;   (lsp-log-max (when rivenemacs-debug message-log-max))
;;   ;; Less intrusive UI
...
(use-package dap-mode
  ...
  :custom
  (dap-utils-extension-path (concat rivenemacs-local-dir "dap/extension/"))
  (dap-breakpoints-file (concat rivenemacs-local-dir "dap/breakpoints.el"))
