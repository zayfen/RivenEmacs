...
(custom-set-faces
 ...
 '(mode-line ((t :box (:line-width 1 :color "#505050" :style nil))))
 '(mode-line-active ((t :box (:line-width 1 :color "#505050" :style nil))))
 '(mode-line-highlight ((t :box (:color "#ffffff"))))
 '(mode-line-inactive ((t :box (:line-width 1 :color "#2d2d2d" :style nil))))
